      ...
      <Card>
        ...
        <CardContent>
          <div className='text-center py-8 text-muted-foreground'>
            ...
            <p>
              Selecciona primero el tipo de comunicación para ver los requisitos
              de archivos
            </p>
          </div>
        </CardContent>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (selectedFile) {
                        if (
                          selectedFile.size >
                          requirement.maxSize * 1024 * 1024
                        ) {
                          alert(
                            `El archivo es demasiado grande. Máximo ${requirement.maxSize}MB`
                          );
                          return;
                        }
          ...
          <div className='flex items-start gap-2'>
            ...
            <div className='text-sm text-blue-800'>
              ...
              <ul className='list-disc list-inside space-y-1'>
                ...
                <li>
                  Todos los archivos serán revisados por el comité científico
                </li>
                <li>
                  Una vez enviada la comunicación, no se podrán modificar los
                  archivos
                </li>
              </ul>
            </div>
