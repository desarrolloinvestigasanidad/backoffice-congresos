...
const initialConfig: PlatformConfig = {
  heroImage:
    "/placeholder.svg?height=600&width=960&text=Plataforma+de+Congresos",
...
export default function ButtonImageEditor() {
  ...
  const [selectedButton, setSelectedButton] = useState<ImageButton | null>(
    null
  );
  ...
  const addNewButton = (
    shape: "rectangle" | "circle" | "polygon" = "rectangle"
  ) => {
  ...
  const handleCanvasClick = (e: React.MouseEvent) => {
    ...
    const point = getRelativeCoordinates(e);
    const clickedButton = config.buttons.find((button) =>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-4 gap-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Selecciona una herramienta para dibujar
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='grid grid-cols-2 gap-2'>
                  ...
                  <Button
                    variant={
                      drawingMode === "rectangle" ? "default" : "outline"
                    }
                    size='sm'
                ...
                {drawingMode === "polygon" && (
                  <div className='text-xs text-muted-foreground p-2 bg-muted rounded'>
                    <strong>Polígono:</strong> Haz clic para añadir puntos.
                    Doble clic para finalizar (mínimo 3 puntos).
                    {isDrawing && (
                      <div className='mt-1 text-green-600'>
                        Puntos actuales: {currentPath.length}{" "}
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateGeneralInfo("subtitle", e.target.value)
                    }
                  />
                </div>
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateGeneralInfo("heroImage", e.target.value)
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <div className='flex gap-1 mt-2'>
                    <Button
                      ...
                      size='sm'
                      className='flex-1'
                      onClick={() => addNewButton("rectangle")}>
            ...
            <Card className='lg:col-span-2'>
              ...
              <CardContent>
                <div
                  ...
                  {/* Botones existentes */}
                  {config.buttons.map((button) =>
                    renderShape(button, selectedButton?.id === button.id)
                  )}
                  ...
                  {isDrawing && currentPath.length > 0 && (
                    <svg
                      ...
                      {currentPath.length >= 3 && (
                        <path
                          d={`M ${currentPath[currentPath.length - 1].x} ${
                            currentPath[currentPath.length - 1].y
                          } L ${currentPath[0].x} ${currentPath[0].y}`}
                          stroke='#ef4444'
                          strokeWidth='0.2'
                          strokeDasharray='2,2'
                          fill='none'
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  {selectedButton
                    ? `Propiedades: ${selectedButton.label}`
              ...
              <CardContent>
                {selectedButton ? (
                  <ButtonPropertiesForm
                    ...
                    onUpdate={updateButtonProperties}
                  />
                ) : (
                  <div className='text-center py-8 text-muted-foreground'>
                    Selecciona un botón en el editor o dibuja uno nuevo para
            ...
            <div className='flex justify-end mt-4'>
              <Button
                ...
                disabled={isSaving}>
                {isSaving ? "Guardando…" : "Guardar en plataforma"}
              </Button>
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value='code'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Edita directamente la configuración en formato JSON
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='relative'>
            ...
            <CardFooter className='flex justify-between'>
              <Button
                variant='outline'
                onClick={() => setJsonCode(JSON.stringify(config, null, 2))}>
                Restablecer
              </Button>
              <Button
                onClick={() => {
